...
#nullable disable
#nullable restore
#line 6 "D:\JM2\WP\CotizadorPrudencia\Solution\Client\Pages\AdminPages\Organizadores\IndexOrganizadores.razor"
using System.Text.Json;

#line default
#line hidden
#nullable disable
    [Microsoft.AspNetCore.Components.RouteAttribute("/admin/Organizadores/{grupoId:int}")]
    public partial class IndexOrganizadores : Microsoft.AspNetCore.Components.ComponentBase
    {
...
#nullable restore
#line 53 "D:\JM2\WP\CotizadorPrudencia\Solution\Client\Pages\AdminPages\Organizadores\IndexOrganizadores.razor"
    ...
    {
        var responseHttp = await repositorio.Get<List<Grupo>>("api/Organizador");
        grupoList = responseHttp.Response;
    }
    private async Task BorrarOrganizador(Organizador organizador)
    {
        var responseHttp = await repositorio.Delete($"api/Organizador/{organizador.OrganizadorId}");
